...
import { getTimeClockReport } from "@/server/services/time-clock.service";
  ...
  return (
    <>
      ...
      <PageBody className="flex flex-col gap-6">
        <PontoPanel initialFrom={toInputValue(from)} initialTo={toInputValue(to)} initialAnomalies={anomalies} />
      </PageBody>
    </>
  );
}
