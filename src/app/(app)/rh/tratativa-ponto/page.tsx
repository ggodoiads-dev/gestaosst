...
import { TratativaPontoPanel } from "./tratativa-ponto-panel";
...
export default async function TratativaPontoPage() {
  ...
  return (
    <>
      <PageHeader
        ...
        description="Vincule batidas não identificadas e veja quem atrasou, faltou, esqueceu de bater o ponto ou não fez o checklist do dia."
      />
